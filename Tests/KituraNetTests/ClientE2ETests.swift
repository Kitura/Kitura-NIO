...
class ClientE2ETests: KituraNetTest {
    ...
    func testRequestSize() {
        performServerTest(serverConfig: ServerOptions(requestSizeLimit: 10000, connectionLimit: 100),delegate,socketType: .tcp, useSSL: false, asyncTasks: { expectation in
