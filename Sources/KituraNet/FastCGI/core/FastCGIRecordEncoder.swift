...
class FastCGIRecordEncoder: FastCGIEncoder {
    ...
    func createRecordStarter() -> Data {
     ...
     //
    func finalizeRequestCompleteRecord(data: inout Data) -> Data {
    ...
    //
    func finalizeRequestBeginRecord(data: inout Data) -> Data {
    ...
    //
    func finalizeParameters(data: inout Data) -> Data {
    ...
    //
    func finalizeDataRecord(data: inout Data) -> Data {
    ...
    //
    public func recordTest() throws -> Void {
